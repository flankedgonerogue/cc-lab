...
{
       0,    93,    93,    94,    98,   100,   108,    99,   121,   125,
...
static const char *const yytname[] =
{
  ...
  "NUM", "RELOP", "'+'", "'-'", "'*'", "'/'", "UMINUS", "'='", "';'",
  "'('", "')'", "$accept", "program", "stmt", "$@1", "$@2", "cond", "expr", YY_NULLPTR
};
...
{
      17,     6,    15,    30,    -7,     4,     4,    -7,    -7,    -7,
      -7,     4,     4,    13,    29,    -6,    -7,    16,    -7,     4,
       4,     4,     4,     4,    -7,    -7,    17,    33,     1,     1,
      -7,    -7,    41,    -7,    17,    -7
};
...
{
       0,     0,     0,     0,     3,     0,     0,     1,     2,    15,
      16,     0,     0,     0,     0,     0,    13,     0,     5,     0,
       0,     0,     0,     0,     4,    14,     0,     8,     9,    10,
      11,    12,     0,     6,     0,     7
};
...
{
       8,    15,    20,    21,    22,    23,    16,    17,    24,     9,
      10,    22,    23,    11,    27,    28,    29,    30,    31,    12,
       1,     5,     2,    32,    20,    21,    22,    23,     6,    18,
       7,    35,    25,     1,     0,     2,    19,    20,    21,    22,
      23,    20,    21,    22,    23,    33
};

static const yytype_int8 yycheck[] =
{
       3,     6,     8,     9,    10,    11,    11,    12,    14,     5,
       6,    10,    11,     9,    19,    20,    21,    22,    23,    15,
       3,    15,     5,    26,     8,     9,    10,    11,    13,    16,
       0,    34,    16,     3,    -1,     5,     7,     8,     9,    10,
      11,     8,     9,    10,    11,     4
};
...
{
       0,     3,     5,    18,    19,    15,    13,     0,    19,     5,
       6,     9,    15,    22,    23,    23,    23,    23,    16,     7,
       8,     9,    10,    11,    14,    16,    20,    23,    23,    23,
      23,    23,    19,     4,    21,    19
};
...
yyreduce:
  ...
  case 4: /* stmt: ID '=' expr ';'  */
#line 98 "parser.y"
                      { emit_assign((yyvsp[-3].str), (yyvsp[-1].str)); }
...
#line 1188 "parser.tab.c"
  ...
  case 7: /* stmt: IF '(' cond ')' $@1 stmt ELSE $@2 stmt  */
#line 114 "parser.y"
      {
...
#line 1197 "parser.tab.c"
  ...
  case 8: /* cond: expr RELOP expr  */
#line 121 "parser.y"
                      { (yyval.str) = make_rel((yyvsp[-2].str), (yyvsp[-1].str), (yyvsp[0].str)); }
#line 1203 "parser.tab.c"
    break;

  case 9: /* expr: expr '+' expr  */
#line 125 "parser.y"
                    { (yyval.str) = emit_binary((yyvsp[-2].str), "+", (yyvsp[0].str)); }
...
#line 1227 "parser.tab.c"
  ...
  case 13: /* expr: '-' expr  */
#line 129 "parser.y"
                            { (yyval.str) = emit_unary("-", (yyvsp[0].str)); }
